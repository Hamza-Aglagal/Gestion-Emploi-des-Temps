...
Route::get('salle-active',[SalleController::class, 'AllSalleActive']);
...
Route::get('prof-active',[ProfesseurController::class, 'AllProfActive']);
...
Route::get('seances/student/{idStudent}',[SeanceController::class, 'GetAllSeanceOfStudent']);
...
Route::get('seanceTemporaire/prof/{id}',[SeanceTemporaireController::class, 'AllSeanceOfProf']);
Route::get('delete-seance/temp/{id}',[SeanceTemporaireController::class, 'DeleteSeanceTemp']);
