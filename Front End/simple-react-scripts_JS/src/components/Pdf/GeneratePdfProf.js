...
import GeneratePdfProfHook from '../../Hook/PDF/generate-pdf-prof-hook';




const GeneratePDFProf = ({IdPROF, ContentRef}) => {
        ...
        >
            ...
            <Box ref={ContentRef}>
                ...
                <Box sx={{ paddingX: '3rem', width: '100%', display: 'flex', flexDirection: 'row', justifyContent: 'space-between', fontWeight: 'bold' }}>
                    ...
                    <Box sx={{}} > Professeur : {`${Prenom} ${Nom} << ${TypeProf} >>`}  </Box>
...
export default GeneratePDFProf