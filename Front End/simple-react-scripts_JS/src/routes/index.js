  ...
  return useRoutes([
    ...
    // // Prof
    {
      ...
      children: [
        ...
        { path: 'seance-reserve', element: <SeanceReserve /> },
...
const SeanceReserve = Loadable(lazy(() => import('../pages/Prof/SeanceReserve')));
const Chat = Loadable(lazy(() => import('../pages/Prof/Chat')));
