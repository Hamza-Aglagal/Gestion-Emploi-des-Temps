        ...
        <header className='SideBarProf' >
            ...
            <div className="navwrapper">
                ...
                <div className="nav mainnav">
                    ...
                    <Link to="/prof/seance-reserve" className={Clicked === '/prof/seance-reserve' ? 'selected navbutton  ' : 'navbutton '} onClick={() => setClicked('/prof/Profile')} >
                        <div className="navicon">
                            <AccessAlarmIcon />
                        </div>
                        <div className="navlabel">
                    ...
                    <Link to="/prof/chat-app" className={Clicked === '/prof/chat-app' ? 'selected navbutton  ' : 'navbutton '} onClick={() => setClicked('/prof/Profile')} >
                        <div className="navicon">
                            <ChatIcon />
                        </div>
                        <div className="navlabel">
